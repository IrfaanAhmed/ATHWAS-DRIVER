package com.app.ia.driver.helper
...
import com.app.ia.driver.callback.PageIndicator
import kotlin.math.abs

class CirclePageIndicator @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = R.attr.vpiCirclePageIndicatorStyle) : View(context, attrs, defStyle),
    PageIndicator {
